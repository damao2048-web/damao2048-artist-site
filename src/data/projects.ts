...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      image("ask-age-08", "Please Don't Ask My Age handmade object", "Please Don't Ask My Age, 2024, handmade object, object documentation."),
      image("ask-age-09", "Please Don't Ask My Age handmade clock object", "Please Don't Ask My Age, 2024, handmade clock object, object documentation."),
      image("ask-age-10", "Please Don't Ask My Age handmade object", "Please Don't Ask My Age, 2024, handmade object, object documentation."),
      image("ask-age-11", "Please Don't Ask My Age handmade object", "Please Don't Ask My Age, 2024, handmade object, object documentation."),
      image("ask-age-12", "Please Don't Ask My Age handmade objects", "Please Don't Ask My Age, 2024, handmade objects, object documentation."),
      image("ask-age-13", "Please Don't Ask My Age handmade objects", "Please Don't Ask My Age, 2024, handmade objects, object documentation."),
      image("ask-age-14", "Please Don't Ask My Age framed object", "Please Don't Ask My Age, 2024, framed object, object documentation."),
      image("ask-age-15", "Please Don't Ask My Age installation detail", "Please Don't Ask My Age, 2024, installation detail, ChangTing Gallery, Tokyo."),
      image("ask-age-16", "Please Don't Ask My Age installation detail", "Please Don't Ask My Age, 2024, installation detail, ChangTing Gallery, Tokyo."),
      image("ask-age-17", "Please Don't Ask My Age hand-painted ball object", "Please Don't Ask My Age, 2024, hand-painted ball object, object documentation."),
      image("ask-age-18", "Please Don't Ask My Age handmade dog object", "Please Don't Ask My Age, 2024, handmade dog object, object documentation."),
      image("ask-age-19", "Please Don't Ask My Age handmade boxes", "Please Don't Ask My Age, 2024, handmade boxes, object documentation."),
      image("ask-age-20", "Dog's Head painting", "Dog's Head, 2024, painting."),
      image("ask-age-21", "Please Don't Ask My Age lamp object", "Please Don't Ask My Age, 2024, lamp object, studio documentation."),
      image("ask-age-22", "Please Don't Ask My Age handmade boxes", "Please Don't Ask My Age, 2024, handmade boxes, object documentation."),
      image("ask-age-23", "Please Don't Ask My Age handmade boxes", "Please Don't Ask My Age, 2024, handmade boxes, object documentation."),
      image("ask-age-24", "Please Don't Ask My Age handmade boxes", "Please Don't Ask My Age, 2024, handmade boxes, object documentation."),
      image("ask-age-25", "Please Don't Ask My Age installation view", "Please Don't Ask My Age, 2024, installation view, ChangTing Gallery, Tokyo.")
    ]
  },
  {
    slug: "schedule-table",
